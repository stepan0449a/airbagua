...
module.exports = {
    ...
    plugins: [
        ...
        new CopyWebpackPlugin([
            ...
            {from: `${PATHS.src}/js/type.min.js`, to: `${PATHS.dist}/assets/js/type.min.js`},
            {from: `${PATHS.src}/js/modernizr.custom.js`, to: `${PATHS.dist}/assets/js/modernizr.custom.js`},
            {from: `${PATHS.src}/js/modernizr.custom.js`, to: `${PATHS.dist}/assets/js/modernizr.custom.js`},
            {from: `${PATHS.src}/js/classie.js`, to: `${PATHS.dist}/assets/js/classie.js`},
